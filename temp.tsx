...
export default function AgencyPage() {
  useEffect(() => {
    const chatbotResponses: Record<string, string> = {
      ...
      pricing: 'Our starting prices: Digital Marketing Ôé╣9,999/mo, Web Dev Ôé╣7,999, SEO Ôé╣8,999/mo, Design Ôé╣5,999. Want details?',
    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .marquee-item::before{content:'Ô£ª';color:var(--green)}
        ...
        <div className="nav-inner">
          ...
          <div className="nav-links">
            ...
            <div className="theme-toggle" role="button" aria-label="Toggle theme">
              <button className="theme-btn active" data-theme="dark" aria-label="Dark mode">­ƒîÖ</button>
              <button className="theme-btn" data-theme="light" aria-label="Light mode">ÔÿÇ´©Å</button>
            </div>
            <a href="#contact" className="nav-cta">Book Free Call</a>
          </div>
          <button className="hamburger" aria-label="Toggle menu">Ôÿ░</button>
        </div>
      </nav>
      ...
      <section className="hero">
        <div className="hero-inner container">
          <div className="hero-left">
            ...
            <p className="hero-desc">No fluff. No guesswork. Just ruthless, data-driven strategies that turn every dollar into 3, 5, or 10x ÔÇö backed by AI, obsessively optimized, and built to compound.</p>
            ...
            <div className="hero-ctas">
              <a href="#contact" className="btn btn-primary">Get Free Strategy Call ÔåÆ</a>
      ...
      <section id="services">
        ...
        <div className="services-grid container">
          <div className="svc reveal reveal-delay-1">
            <div className="svc-icon g">­ƒÜÇ</div>
          ...
          <div className="svc reveal reveal-delay-2">
            <div className="svc-icon b">­ƒÄ»</div>
          ...
          <div className="svc reveal reveal-delay-3">
            <div className="svc-icon p">­ƒÆ░</div>
          ...
          <div className="svc reveal reveal-delay-4">
            <div className="svc-icon o">­ƒô▒</div>
          ...
          <div className="svc reveal reveal-delay-5">
            <div className="svc-icon b">ÔÜí</div>
          ...
          <div className="svc reveal reveal-delay-5">
            <div className="svc-icon g">­ƒñû</div>
      ...
      <section id="pricing">
        ...
        <div className="pricing-grid container">
          <div className="price-card reveal reveal-delay-1">
            <div className="price-icon g">­ƒôê</div>
            <h3>Digital Marketing</h3>
            <div className="price">Ôé╣9,999<span>/Month</span></div>
          ...
          <div className="price-card reveal reveal-delay-2">
            <div className="price-icon o">­ƒÄ¿</div>
            <h3>Design & Branding</h3>
            <div className="price">Ôé╣5,999<span /></div>
            <p>Logo, Graphics, Creatives, Branding</p>
            <a href="#contact" className="btn btn-outline">Start Growing</a>
          </div>
          <div className="price-card reveal reveal-delay-3">
            <div className="price-icon b">­ƒÆ╗</div>
            <h3>Web Development</h3>
            <div className="price">Ôé╣7,999<span /></div>
            <p>Modern, Responsive, Custom Solutions</p>
            <a href="#contact" className="btn btn-outline">Start Growing</a>
          </div>
          <div className="price-card reveal reveal-delay-4">
            <div className="price-icon p">­ƒöì</div>
            <h3>SEO</h3>
            <div className="price">Ôé╣8,999<span>/Month</span></div>
            <p>On-Page, Off-Page, Technical SEO</p>
            <a href="#contact" className="btn btn-outline">Start Growing</a>
          </div>
          <div className="price-card reveal reveal-delay-5">
            <div className="price-icon g">­ƒô▒</div>
            <h3>Social Media</h3>
      ...
      <section id="portfolio">
        <div className="sec-head reveal">
          ...
          <p>Every project is a profit system ÔÇö engineered, tested, and scaled. Don&apos;t take our word for it. See the receipts.</p>
        </div>
        <div className="container">
          {/* GYMFLOW SAAS - FEATURED PROJECT */}
          <div className="portfolio-cat reveal">
            <div className="cat-title">­ƒÅå Featured Project ÔÇö Gymflow SaaS</div>
            ...
            <div className="portfolio-grid">
              <div className="pf-card pf-featured pf-gymflow" id="gymflow-card">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#ff6b35,#ff9f1c,#ffbf69)'}} data-tag="SaaS ÔÇó Fitness Tech">
                  <div className="gymflow-preview-icons">­ƒÅï´©Å­ƒô▒­ƒÆ│­ƒôè</div>
                </div>
                <div className="pf-body">
                  ...
                  <div className="gymflow-btns">
                    <a href="https://gymflow-saas.vercel.app/" target="_blank" className="btn btn-primary">­ƒîÉ Live Web App</a>
                    <a href="https://expo.dev/artifacts/eas/mmUgBVLCg7NSpwHwBpn2AA.apk" target="_blank" className="btn btn-outline">­ƒô▓ Download APK</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="portfolio-cat reveal">
            <div className="cat-title">­ƒöÑ Recent Work ÔÇö WhatsApp CRM MVP</div>
            ...
            <div className="portfolio-grid">
              <a href="https://drive.google.com/file/d/16dHEoRCJvwYv6YEa9Qe8a7HSuxVc_iTT/view?usp=sharing" target="_blank" className="pf-card pf-featured">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#1877f2,#a855f7)'}} data-tag="Featured Report">­ƒôè</div>
                <div className="pf-body">
                  <h3>Meta Ads Performance Audit & Optimization Report</h3>
                  <p>A full-spectrum audit dissecting campaign structure, audience segmentation, creative fatigue, and bidding strategy ÔÇö exposing exactly where ad spend was leaking and mapping a step-by-step optimization blueprint to unlock exponential ROAS.</p>
                  <span className="pf-link">View Full Report ÔåÆ</span>
                </div>
              </a>
              <a href="https://frontend-omega-eight-zbfx853zu2.vercel.app" target="_blank" className="pf-card">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#25d366,#128c7e)'}} data-tag="Live CRM">­ƒô▒</div>
                <div className="pf-body">
                  ...
                  <span className="pf-link">View Frontend ÔåÆ</span>
                </div>
              </a>
            </div>
          </div>
          ...
          {/* Telegram */}
          <div className="portfolio-cat reveal">
            <div className="cat-title">­ƒô▒ Telegram Channel Landing Pages</div>
            ...
            <div className="portfolio-grid">
              <a href="https://vip-free-tennis-page.vercel.app/" target="_blank" className="pf-card">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#00b847,#008335)'}} data-tag="Live">­ƒÄ¥</div>
                <div className="pf-body">
                  <h3>VIP Free Tennis</h3>
                  <p>Free tennis tips & predictions page that converts sports enthusiasts into loyal members</p>
                  <span className="pf-link">View Live ÔåÆ</span>
                </div>
              </a>
              <a href="https://tennis-king-jackpot.vercel.app/" target="_blank" className="pf-card">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#ffd700,#ff8c00)'}} data-tag="Live">­ƒææ</div>
                <div className="pf-body">
              ...
              <a href="https://cricket-king-rahul.vercel.app/" target="_blank" className="pf-card">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#ff4757,#c0392b)'}} data-tag="Live">­ƒÅÅ</div>
                <div className="pf-body">
              ...
              <a href="https://hari-cricket.vercel.app/" target="_blank" className="pf-card">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#3742fa,#2f3542)'}} data-tag="Live">­ƒÅÅ</div>
                <div className="pf-body">
                  <h3>Hari Cricket</h3>
              ...
              <a href="https://rahul-silk.vercel.app/" target="_blank" className="pf-card">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#a55eea,#8854d0)'}} data-tag="Live">­ƒºú</div>
                <div className="pf-body">
                  <h3>Rahul Silk</h3>
          ...
          {/* Custom Development */}
          <div className="portfolio-cat reveal">
            <div className="cat-title">­ƒÆ╗ Custom Development Projects</div>
            <div className="cat-sub">Full-stack platforms engineered for speed, scale, and conversion from day one</div>
            <div className="portfolio-grid">
              <a href="https://frontend-omega-eight-zbfx853zu2.vercel.app" target="_blank" className="pf-card">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#25d366,#128c7e)'}} data-tag="Full Stack MVP">­ƒô▒</div>
                <div className="pf-body">
                  <h3>WhatsApp CRM - Full Stack MVP</h3>
              ...
              <a href="https://whatsapp-crm-backend-one.vercel.app" target="_blank" className="pf-card">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#4d9fff,#2d7dd2)'}} data-tag="Backend API">ÔÜÖ´©Å</div>
                <div className="pf-body">
                  ...
                  <span className="pf-link">View Backend API ÔåÆ</span>
                </div>
              </a>
              <a href="https://gplesports.vercel.app/" target="_blank" className="pf-card">
                <div className="pf-preview" style={{background:'linear-gradient(135deg,#ff6b35,#f7931e)'}} data-tag="Live">ÔÜ¢</div>
                <div className="pf-body">
                  <h3>GPLE Sports</h3>
      ...
      <section id="profile">
        ...
        <div className="profile-grid container">
          <div className="prf reveal reveal-delay-1">
            <div className="prf-icon">­ƒÄô</div>
            <h3>Elite Education</h3>
            <p>University of Delhi (2022ÔÇô2026), BA from Vinayaka Missions Sikkim University. Strong academic foundation from BSEB and CBSE boards.</p>
          </div>
          <div className="prf reveal reveal-delay-2">
            <div className="prf-icon">­ƒÅå</div>
      ...
      <section id="contact">
        ...
        <div className="lead-form reveal">
          <h3>­ƒÜÇ Get Your Free Consultation</h3>
          <form id="leadForm">
            ...
            <button type="submit" className="btn btn-primary">Send Inquiry ÔåÆ</button>
          </form>
        </div>
      </section>
      ...
      <section className="cta-section">
        <div className="cta-inner reveal">
          ...
          <div className="cta-btns">
            <a href="#contact" className="btn btn-primary">Book Free Consultation ÔåÆ</a>
      ...
      <footer>
        ...
        <p style={{marginTop:'.5rem',fontSize:'.75rem',color:'var(--text-muted)'}}>Powered by <strong style={{color:'var(--green)'}}>Signhify</strong> ÔÇö Building premium SaaS products</p>
      </footer>
      ...
      <div className="chatbot" id="chatbot">
        <div className="chatbot-window">
          <div className="chatbot-header">
            <span>­ƒñû Signhify AI Assistant</span>
            <button className="chatbot-close" aria-label="Close chat">├ù</button>
          </div>
          ...
          <div className="chatbot-input">
            ...
            <button aria-label="Send message">Ô×ñ</button>
          </div>
        </div>
        <button className="chatbot-toggle" aria-label="Open chat">­ƒÆ¼</button>
      </div>
    </>
  )
}
